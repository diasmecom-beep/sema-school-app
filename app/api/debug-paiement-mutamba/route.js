...
// Diagnostic temporaire - vérifie si Mutamba Kalonji a payé, et avec quel
// moyen de paiement. À supprimer après vérification.
export async function GET() {
  ...
  const match = sessions.find(
    (s) =>
      s.customer_details?.email?.toLowerCase() === "mutkal27@gmail.com" ||
      s.customer_email?.toLowerCase() === "mutkal27@gmail.com"
  );
