    ...
    <div className="bg-sage-800 text-cream">
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between gap-6">
        <a href="/" className="flex flex-col shrink-0">
          <div className="relative h-24 w-72 shrink-0">
            ...
            <Image
              ...
              width={70}
              height={55}
              className="absolute bottom-2 right-0 h-14 w-auto"
              aria-hidden="true"
            />
          </div>
          <span className="block text-sm italic font-body text-cream/90 leading-tight mt-1 ml-1">
